                ...
                <form className="card-body">
                    ...
                    <div className='gap-8 md:flex'>
                        <div className="md:w-1/2 form-control">
                            ...
                            <input type="text" placeholder=" Seller Picture" className="input input-bordered" />
                        </div>
                        <div className="form-control md:w-1/2">
                            <label className="label">
                    ...
                    <div className="form-control">
                        ...
                        <textarea placeholder="Detail" className="w-full textarea textarea-bordered textarea-md" ></textarea>
                    </div>
