...
const Gallery = () => {
    return (
        <div>
            <h1 className='pt-20 text-5xl font-semibold text-center'><span className='border-b'>TOY GALLERY</span></h1>
            <div className='py-12'>
                <div className='grid-cols-3 gap-6 md:grid ms-4'>
                    <div className="shadow-xl w-[380px]  rounded-sm bg-neutral-600 text-neutral-content">
