...
const Blog = () => {
    return (
        <div>
            ...
            <h1 className='py-12 text-5xl font-bold text-center text-rose-500'><span className='pb-4 border-b border-rose-500'>Question And Answer</span></h1>
            <div className=''>
                <div className='p-6'>
                    <h3 className='pb-6 text-2xl font-semibold text-rose-500'><span className='border-b'>Qus-1: </span> What is an access token and refresh token? How do they work and where should we store them on the client-side?</h3>
                ...
                <div className='p-6'>
                    <h3 className='pb-6 text-2xl font-semibold text-rose-500'><span className='border-b'>Qus-2: </span> Compare SQL and NoSQL databases?</h3>
                ...
                <div className='p-6'>
                    <h3 className='pb-6 text-2xl font-semibold text-rose-500'><span className='border-b'>Qus-3: </span> What is express js? What is Nest JS?</h3>
                ...
                <div className='p-6'>
                    <h3 className='pb-6 text-2xl font-semibold text-rose-500'><span className='border-b'>Qus-4: </span> What is MongoDB aggregate and how does it work?</h3>
